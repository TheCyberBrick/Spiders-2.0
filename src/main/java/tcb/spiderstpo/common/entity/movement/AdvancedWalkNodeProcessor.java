...
public class AdvancedWalkNodeProcessor<T extends MobEntity & IAdvancedPathFindingEntity> extends WalkNodeProcessor {
	...
	public PathPoint getStart() {
		...
		if(this.getCanSwim() && this.entity.isInWater()) {
			by = MathHelper.floor(this.entity.getPosY());
			BlockPos.Mutable blockpos = new BlockPos.Mutable(this.entity.getPosX(), (double) by, this.entity.getPosZ());

			for(BlockState blockstate = this.blockaccess.getBlockState(blockpos); blockstate.getBlock() == Blocks.WATER || blockstate.getFluidState() == Fluids.WATER.getStillFluidState(false); blockstate = this.blockaccess.getBlockState(blockpos)) {
				++by;
				blockpos.setPos(this.entity.getPosX(), (double) by, this.entity.getPosZ());
			}

...
public class CollisionSmoothingUtil {
	...
	private static class BoxConsumer implements VoxelShapes.ILineConsumer {
		...
		private final Vec3d p;
		private final float boxScale;

		private BoxConsumer(Vec3d p, float boxScale) {
			this.p = p;
	...
	@Nullable
	public static Pair<Vec3d, Vec3d> findClosestPoint(Consumer<VoxelShapes.ILineConsumer> consumer, Vec3d pp, Vec3d pn, float smoothingRange, float boxScale, float dx, int iters, float threshold, Vec3d p) {
	...
	@Nullable
	public static Pair<Vec3d, Vec3d> findClosestPoint(List<AxisAlignedBB> boxes, Vec3d pp, Vec3d pn, float smoothingRange, float boxScale, float dx, int iters, float threshold, Vec3d p) {
		if(boxes.isEmpty()) {
			return null;
		}
	...
	@Nullable
	private static Pair<Vec3d, Vec3d> findClosestPoint(float[] erx, float[] ery, float[] erz, float[] ecx, float[] ecy, float[] ecz, int count, Vec3d pp, Vec3d pn, float smoothingRange, float boxScale, float dx, int iters, float threshold, Vec3d p) {
